...
export const localizedLocales = ['es', 'pt', 'it', 'fr', 'de', 'hi', 'bn'] as const;
...
export const localeMeta: Record<SupportedLocale, LocaleMeta> = {
  ...
  bn: {
    ...
    nativeName: 'বাংলা',
    shortName: 'BN',
    siteDescription: 'কৃত্রিম বুদ্ধিমত্তার ধারণা, আর্কিটেকচার ও আধুনিক অনুশীলন সহজভাবে বোঝার জন্য একটি জীবন্ত বাংলা অভিধান।',
    homeHeading: 'বাংলায় এআই অভিধান',
    homeIntro: 'আধুনিক কৃত্রিম বুদ্ধিমত্তার গুরুত্বপূর্ণ শব্দ ও ধারণাগুলো সহজভাবে বোঝার একটি জীবন্ত নির্দেশিকা।',
    definitionLabel: 'সংজ্ঞা',
    noteLabel: 'সংক্ষেপে',
...
export const localizedEntries: Record<LocalizedLocale, readonly LocalizedEntry[]> = {
  ...
  bn: [
    {
      key: 'artificial intelligence', slug: 'artificial-intelligence', word: 'Artificial Intelligence',
      definition: 'এমন একটি ক্ষেত্র যেখানে মেশিন বা সফটওয়্যারকে উপলব্ধি, যুক্তি, শেখা, বিষয়বস্তু তৈরি বা সিদ্ধান্ত নেওয়ার মতো কাজ করতে সক্ষম করা হয়।',
      note: 'এটি সবচেয়ে বিস্তৃত ধারণা। মেশিন লার্নিং, জেনারেটিভ এআই এবং এজেন্টিক সিস্টেম এর ভেতরের প্রধান ক্ষেত্র বা পদ্ধতি।'
    },
    {
      key: 'machine learning', slug: 'machine-learning', word: 'Machine Learning',
      definition: 'এআই-এর এমন একটি পদ্ধতি যেখানে একটি সিস্টেম ডেটা থেকে প্যাটার্ন শেখে এবং প্রতিটি নিয়ম আলাদাভাবে প্রোগ্রাম না করেও পূর্বাভাস, শ্রেণিবিন্যাস বা সিদ্ধান্ত নিতে পারে।',
      note: 'মেশিন লার্নিং কৃত্রিম বুদ্ধিমত্তার একটি অংশ, পুরো এআই ক্ষেত্রের আরেকটি নাম নয়।'
    },
    {
      key: 'generative AI', slug: 'generative-ai', word: 'Generative AI',
      definition: 'এমন এআই সিস্টেম যা শেখা প্যাটার্নের ভিত্তিতে নতুন লেখা, ছবি, অডিও, ভিডিও, কোড বা অন্য ধরনের বিষয়বস্তু তৈরি করতে পারে।',
      note: 'নতুন বিষয়বস্তু তৈরি করা এআই-এর একটি নির্দিষ্ট ক্ষমতা; এটি সব বুদ্ধিমান সিস্টেমকে বোঝায় না।'
    },
    {
      key: 'large language model', slug: 'large-language-model', word: 'Large Language Model (LLM)',
      definition: 'বৃহৎ পরিসরে প্রশিক্ষিত এমন একটি ভাষা মডেল, যা টোকেনের ধারাবাহিকতা অনুমান ও তৈরি করতে পারে এবং সাধারণত বিপুল পরিমাণ লেখা ও কোড থেকে শেখে।',
      note: 'LLM একটি মডেলের শ্রেণি। একটি পূর্ণ এআই পণ্যে এর সঙ্গে টুল, মেমোরি, সার্চ এবং অ্যাপ্লিকেশন লজিকও থাকতে পারে।'
    },
    {
      key: 'prompt', slug: 'prompt', word: 'Prompt',
      definition: 'এআই মডেলকে দেওয়া নির্দেশনা, প্রসঙ্গ, উদাহরণ বা প্রশ্ন, যা মডেলের উত্তরের দিক ও কাঙ্ক্ষিত আকার নির্ধারণ করতে সাহায্য করে।',
      note: 'একটি ভালো প্রম্পট লক্ষ্য, সীমাবদ্ধতা এবং প্রত্যাশিত আউটপুটের ধরন পরিষ্কার করে।'
    },
    {
      key: 'token', slug: 'token', word: 'Token',
      definition: 'ভাষা মডেল যে ছোট ছোট পাঠ্য একক প্রক্রিয়া করে তাকে টোকেন বলা হয়। একটি টোকেন পুরো শব্দ, শব্দের অংশ বা বিরামচিহ্নও হতে পারে।',
      note: 'টোকেনের সংখ্যা কনটেক্সট সীমা, প্রতিক্রিয়ার গতি এবং অনেক ক্ষেত্রে খরচকে প্রভাবিত করে।'
    },
    {
      key: 'context window', slug: 'context-window', word: 'Context Window',
      definition: 'একটি মডেল উত্তর তৈরি করার সময় একসঙ্গে যতটা তথ্য সামনে রাখতে ও ব্যবহার করতে পারে, সেই সর্বোচ্চ পরিমাণকে কনটেক্সট উইন্ডো বলা হয়।',
      note: 'বেশি কনটেক্সট মানেই ভালো কনটেক্সট নয়। প্রাসঙ্গিক ও সঠিক তথ্য বেশি গুরুত্বপূর্ণ।'
    },
    {
      key: 'taste', slug: 'taste', word: 'Taste',
      definition: 'এআই দ্রুত অনেক সম্ভাব্য বিকল্প তৈরি করতে পারলেও কোনটি সুসংগত, কার্যকর, মার্জিত, উপযুক্ত বা উচ্চমানের তা চিনে নেওয়ার মানুষের ক্ষমতাই Taste।',
      note: 'এআই যত সহজে বিকল্প তৈরি করে, মানুষের নির্বাচন ও দিকনির্দেশনার মূল্য তত বাড়ে।'
    },
    {
      key: 'hallucination', slug: 'hallucination', word: 'Hallucination',
      definition: 'এমন একটি এআই উত্তর যা আত্মবিশ্বাসী ও স্বাভাবিক শোনালেও তাতে বানানো, সমর্থনহীন বা ভুল তথ্য থাকে।',
      note: 'স্বচ্ছন্দ ভাষা সঠিকতার নিশ্চয়তা দেয় না। গুরুত্বপূর্ণ দাবি যাচাই করা উচিত।'
    },
    {
      key: 'RAG', slug: 'retrieval-augmented-generation-rag', word: 'Retrieval-Augmented Generation (RAG)',
    ...
    },
    {
      ...
      definition: 'এমন এআই ক্ষমতা যেখানে একটি সিস্টেম লক্ষ্য পূরণের জন্য একাধিক ধাপে কাজ করে, নিজে পদক্ষেপ বেছে নেয় এবং কিছুটা স্বায়ত্তশাসনের সঙ্গে টুল ব্যবহার করে।',
      note: 'মূল পার্থক্য হলো, সিস্টেম শুধু একবার উত্তর দেয় না; এটি কাজ করে এবং প্রক্রিয়াটি সামনে এগিয়ে নিয়ে যায়।'
    }
  ]
};
