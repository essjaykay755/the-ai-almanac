...
const copy: Partial<Record<SupportedLocale, TutorialCopy>> = {
  ...
  bn: {
    ...
    sidebar: { title: 'সাইডবার ব্যবহার করুন', body: 'সাইডবার থেকে খুঁজুন, সব শব্দ দেখুন, বুকমার্ক ও আগের দেখা শব্দ খুলুন, সময়রেখা দেখুন, সংগ্রহ গুছিয়ে রাখুন, অন্য কোনো শব্দ দেখুন, এন্ট্রি সেভ করুন বা পরিচিতি পড়ুন।' },
    ...
    bookmark: { title: 'কাজের এন্ট্রি কাছে রাখুন', body: 'বর্তমান এন্ট্রি সেভ করতে বুকমার্ক রিবন ব্যবহার করুন। সেভ করা এন্ট্রিগুলো বুকমার্ক অংশে পাওয়া যাবে।' },
    'entry-actions': { title: 'সেভ, গুছিয়ে রাখা ও শেয়ার', body: 'একটি এন্ট্রি সংগ্রহে যোগ করুন, ডিজাইন করা কপি সেভ করুন, সরাসরি লিংক কপি করুন বা পাতার অ্যাকশন থেকে সময়রেখা খুলুন।' },
